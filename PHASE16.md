...
- Scaffold, billing, extra production deploys unless the owner names them. Go-live 11 Sep 2026 covered hosting, Firestore rules, `extractJobFileText` and `askRisingAmp` only.
