...
1. Confirm git branch. Latest work is **`phase-11-cold-start`**. Phase 10 Cost Plan is live. Phase 11 Parts A, B and C (app-shell service worker + Firestore disk cache + directories on the screen that uses them) are on the branch, **not deployed**. Restore tag: `pre-phase11-2026-09-05`. Never commit to `master` or `main`. Older restore tags: `pre-phase10-2026-09-02`, `pre-phase10-2026-08-31`, `pre-phase9-2026-08-31`, `pre-phase8-2026-08-28`, `pre-phase7-2026-08-28`, `pre-phase6-2026-08-27`, `pre-phase1-2026-08-22`.
...
5. **Next:** Part D — scope `queryClient.invalidateQueries()` so a write only invalidates the keys it changes. Do not start Part E. Do not deploy unless he names the project and surface.
