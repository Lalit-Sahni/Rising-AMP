...
organizations/{orgId}
  ...
  assistantWritesEnabled                   # Phase 17 Part A inverted the default. Owner-only boolean. Explicit false = assistant writes off. Missing means ON (code from phase-18-people, live on staging and production 19 Sep 2026). Undo of an already-applied receipt still works when off.
