...
organizations/{orgId}
  ...
  assistantWritesEnabled                   # Phase 15 Part E. Owner-only boolean. Missing or not true = assistant writes off (createExpense / codeExpense / codeExpenseBatch refused). Undo of an already-applied receipt still works. Schema in the repo; not deployed.
