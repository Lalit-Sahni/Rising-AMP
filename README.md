...
- `firebase deploy --only functions` without naming the function. Production functions are `sendJobInviteEmail`, `readReceiptImage`, `allocateInvoiceNumber`, `checkEstimateImport` and `readQuoteFile`. Deploy **by name**.
